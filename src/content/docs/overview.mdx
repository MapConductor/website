...
head:
  - tag: meta
    attrs:
      name: description
      content: MapConductor is an open-source middleware SDK that unifies multiple map SDKs behind one programming model for location-based apps.
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">
    ![You are stuck on building a map application](~/assets/overview/en/1.png)
  </div>
  <div class="flex-1" style="margin: 0px;">
    ![Why is making a map app this hard? It should be easier...](~/assets/overview/en/2.png)
  </div>
  <div class="flex-1" style="margin: 0px;">
    ![Different syntax, different behavior..., this is too hard!](~/assets/overview/en/3.png)
  </div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">
    ![Ta-da!](~/assets/overview/en/4.png)
  </div>
  <div class="flex-1" style="margin: 0px;">
    ![Looks like you're stuck. I'm MapConductor.](~/assets/overview/en/5.png)
  </div>
  <div class="flex-1" style="margin: 0px;">
    ![I help map SDKs speak the same language!](~/assets/overview/en/6.png)
  </div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">
    ![With MapConductor, you can use any map SDK with the same syntax.](~/assets/overview/en/7.png)
  </div>
  <div class="flex-1" style="margin: 0px;">
    ![Wait! So, I can use the same code for Google Maps and Mapbox?](~/assets/overview/en/8.png)
  </div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">
    ![Markers, polylines, camera controls, events - you can do it all!](~/assets/overview/en/9.png)
  </div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">
    ![Wow! The same code works! This makes development so much easier!](~/assets/overview/en/10.png)
  </div>
  <div class="flex-1" style="margin: 0px;">
    ![Whoa! This is so easy! I can even do this!](~/assets/overview/en/11.png)
  </div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">
    ![And it gets even better - the same code works on iOS and
    Android!](~/assets/overview/en/12.png)
  </div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">
    ![Pretty simple, right?](~/assets/overview/en/13.png)
  </div>
</div>
