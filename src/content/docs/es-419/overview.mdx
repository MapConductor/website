...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">![Estás atascado construyendo una app de mapas](~/assets/overview/es-419/1.png)</div>
  <div class="flex-1" style="margin: 0px;">![¿Por qué hacer una app de mapas es tan difícil? Debería ser más fácil...](~/assets/overview/es-419/2.png)</div>
  <div class="flex-1" style="margin: 0px;">![Sintaxis distinta, comportamiento distinto..., ¡esto es demasiado difícil!](~/assets/overview/es-419/3.png)</div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">![¡Tachán!](~/assets/overview/es-419/4.png)</div>
  <div class="flex-1" style="margin: 0px;">![Parece que estás atascado. Soy MapConductor.](~/assets/overview/es-419/5.png)</div>
  <div class="flex-1" style="margin: 0px;">![Estamos creando un lenguaje común para los SDK de mapas!](~/assets/overview/es-419/6.png)</div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">![Con MapConductor, puedes usar cualquier SDK de mapas con la misma sintaxis.](~/assets/overview/es-419/7.png)</div>
  <div class="flex-1" style="margin: 0px;">![¡Espera! Entonces, ¿puedo usar el mismo código para Google Maps y Mapbox?](~/assets/overview/es-419/8.png)</div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">![Marcadores, polilíneas, control de cámara, eventos: ¡puedes hacerlo todo!](~/assets/overview/es-419/9.png)</div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">![¡Guau! ¡El mismo código funciona! ¡Esto hace el desarrollo mucho más fácil!](~/assets/overview/es-419/10.png)</div>
  <div class="flex-1" style="margin: 0px;">![¡Wow! ¡Esto es muy fácil! ¡Hasta yo puedo hacerlo!](~/assets/overview/es-419/11.png)</div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">![Y se pone aún mejor: ¡el mismo código funciona en iOS y Android!](~/assets/overview/es-419/12.png)</div>
</div>
...
<div class="flex flex-wrap manga">
  <div class="flex-1" style="margin: 0px;">![Bastante simple, ¿no?](~/assets/overview/es-419/13.png)</div>
</div>
